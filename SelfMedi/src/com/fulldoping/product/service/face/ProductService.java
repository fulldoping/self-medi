...
public interface ProductService {
	 ...
	 */
	List<ProductInfo> getAllProduct(PagingProduct paging);
	/**
	 * 페이징 객체 생성
	 * 
	 * 요청파라미터 curPage를 구한다
	 ...
	 */
	PagingProduct getPaging(HttpServletRequest req);
	 ...
	 */
	List<CompBasket> getBasketList(int userNo);
	 ...
	 */
	List<ProductInfo> getProductList(List<CompBasket> basketList);
	 ...
	 */
	List<ProductInfo> getProductInfo(long[] productsId);
	
	
	List<Map<String, Object>> getNutirentInfoWithKind(long[] productsId);
	 ...
	 */
	List<ProductInfo> getProduct(HttpServletRequest req, PagingProduct paging);
