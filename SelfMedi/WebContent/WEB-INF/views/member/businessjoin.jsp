...
<form id="form" name="frmMember" action="/member/businessjoin" method="post">
...
<thead>	
	<tr class="userId">
		...
		<td>
			<input type="text" id="userId" name="userId" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합" />
	...
	<tr class="agree">
		...
		<div class="checkView">
			<label class="check_agree label_block">
				<input type="checkbox" name="agree">
				<span class="agree">마케팅 정보 수진 (선택) 이메일</span>
			</label>
			<a href="#">약관보기 ></a>
		</div>			
		</td>
