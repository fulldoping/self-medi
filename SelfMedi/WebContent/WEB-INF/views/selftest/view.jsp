...
.tg .tg-c3ow{border-color:inherit;text-align:center;vertical-align:top; padding: 20px 10px;}
.tg .tg-0pky{border-color:inherit;text-align:left;vertical-align:top; padding: 20px 10px;}
strong{color:tomato;}
.title{background-color:rgba(0,200,0,45%); display: inline-block; font-size: 20px; font-weight: bold; padding:30px 15px; border-radius: 20px 20px 20px 20px;}
</style>

<div id="container">

<h1 id="title"><b>자가진단 결과</b></h1>
<hr>
...
<c:if test="${testInfo.userAge eq 'youth' }">
  <tr>
    ...
    <td class="tg-c3ow"><a href="#">상품 이동</a></td>
  </tr>
</c:if> 
