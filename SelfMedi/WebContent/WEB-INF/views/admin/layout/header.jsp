...
// 	$("#btnMain").click( function() { $(location).attr("href", "/main"); });
	...
	//자유게시판 신고된 게시글 관리
	$("#btnfreedeclare").click( function() { $(location).attr("href", "/ad/freedeclare/list"); });
	//QnA신고된 게시글 관리
	$("#btnDeclare").click( function() { $(location).attr("href", "/ad/qnadeclare/list"); });
	//상품관리
...
<a href="<%=request.getContextPath() %>/ad/freedeclare/list" class="myButton">자유게시판 신고된 게시글</a><br><br>
<a href="<%=request.getContextPath() %>/ad/qnadeclare/list" class="myButton">QnA 신고된 게시글</a><br><br>
