...
//		console.log($(this).parent().attr('data-commentNo'))
	...
	$(document.body).on("click", ".btnPwUpdate", function() {
		...
		if(th.parent().children(".oldPw").val() != ${member.userPw}){
			if(confirm("현재 비밀번호를 정확하게 입력해주세요")){
				history.go(0);
			}
		}else{
...
<label><a href="/main" style="text-decoration-line : none; color : #345EE6; font-weight : bold; font-size : 2.5em; margin : 0 1% 0 0;">Self-Medi</a></label>
<label style="color : #345EE6; font-weight : bold; font-size : 1em;">프로필 수정</label>
<hr style="width : 100%;  margin : 0 0 0 0; border: solid 1px  #345EE6; background-color :  #345EE6;clear : both;">

<div style="width : 70%; margin : 2% 0 0 15%;">

<div style="margin : 0 0 15px 0">
	<label style="font-weight : bold; font-size : 0.8em;">${member.userNick }님의 연락처 정보입니다</label><br>
	<label style="font-size : 0.8em;">회원정보는 개인정보처리방침에 따라 안전하게 보호되며, 회원님의 명백한 동의 없이 공개 또는 제 3자에게 제공되지 않습니다.
	<a href="/main">개인정보 처리방침</a></label>
</div>
